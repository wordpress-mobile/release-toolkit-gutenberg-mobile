...
<!-- wp:paragraph -->
<p>o Merge the <strong>gutenberg-mobile</strong> PR to <code>trunk</code>. Use "Create a merge commit" option when merging to avoid lossing any commit history from the release branch.</p>
<!-- /wp:paragraph -->
